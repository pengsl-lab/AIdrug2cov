# -*- coding: utf-8 -*-
"""
Created on Mon February 15 2020

Part of codes refer to: https://github.com/FangpingWan/NeoDTI

Cross validation for AIdrug2cov.
"""
...
def extract_prembedding(d=10):
    num = 0
    feature_list = []
    with open('path/Network Representation vector.txt', 'r') as f:
...
for r in range(10):
    ...
    if r == 0:
        test_result = open("path/TDI_result.txt", "w")
    else:
        test_result = open("path/TDI_result.txt", "a")
